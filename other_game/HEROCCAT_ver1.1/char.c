...
void sad_ending()
{
    ...
    printf("       d8888 888 888     8888888b.  d8b          ");
    SetCurrentCursorPos(10, 6);
    printf("      d88888 888 888     888  \"Y88b Y8P          ");
    SetCurrentCursorPos(10, 7);
    printf("     d88P888 888 888     888    888              ");
    SetCurrentCursorPos(10, 8);
    printf("    d88P 888 888 888     888    888 888  .d88b.  ");
    SetCurrentCursorPos(10, 9);
    printf("   d88P  888 888 888     888    888 888 d8P  Y8b ");
    SetCurrentCursorPos(10, 10);
    printf("  d88P   888 888 888     888    888 888 88888888 ");
    SetCurrentCursorPos(10, 11);
    printf(" d8888888888 888 888     888  .d88P 888 Y8b.     ");
    SetCurrentCursorPos(10, 12);
    printf("d88P     888 888 888     8888888P\"  888  \"Y8888  ");
    SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 15);
    SetCurrentCursorPos(18, 18);
    delay_print("곧 타이틀 화면으로 돌아갑니다.");
    Sleep(4000);
}
